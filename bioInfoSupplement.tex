...
\linespread{1}
\begin{lstlisting}
~/DEploid/utilities/dataExplore.r -vcf PG0395-C.vcf.gz \
...
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{{supplementDEploidExample/PG0395-CaltVsRefAndWSAFvsPLAF}.png}
...
\centering
\subfloat[][]{
\includegraphics[width=0.9\textwidth]{{DEploid-Supplementary-Materials/PG0396-C_seed5k5.interpretDEploidFigure.1}.png}
}
...
\centering
\subfloat[][]{
\includegraphics[width=1.3\textwidth]{{DEploid-Supplementary-Materials/PG0396-C_seed5k5.interpretDEploidFigure.2}.png}
}
...
\todonum[inline]{REV1.18: Figure S2.2: inconsistencies in WSAF in figures (a) and (b). Histogram of WSAF in panel (a) shows clustering around 0.3 and 1 while the distributions of WSAF across each chromosome in panel (b) cluster around 0.3 and 0? \textcolor{red}{JOE: I don't understand this comment...}}
\end{figure}
...
\centering{}
\subfloat[][]{
\includegraphics[width=1.3\textwidth]{{DEploid-Supplementary-Materials/PG0396-C_seed5k5.single0}.png}
}
\caption{}
\end{figure}
...
\subfloat[][]{
\includegraphics[width=1.3\textwidth]{{DEploid-Supplementary-Materials/PG0396-C_seed5k5.single1}.png}
}
\caption{}
\end{figure}
...
\centering{}
\subfloat[][]{
\includegraphics[width=1.3\textwidth]{{DEploid-Supplementary-Materials/PG0396-C_seed5k5.single2}.png}
}
\caption{}
\end{figure}
...
\centering{}
\subfloat[][]{
\includegraphics[width=1.3\textwidth]{{DEploid-Supplementary-Materials/PG0396-C_seed5k5.single3}.png}
}
\caption{}
\end{figure}
...
\centering{}
\subfloat[][]{
\includegraphics[width=1.3\textwidth]{{DEploid-Supplementary-Materials/PG0396-C_seed5k5.single4}.png}
}
...
\centering{}
\subfloat[][]{
\includegraphics[width=.6\textwidth]{{deconv/effectiveK/eff_k_both.veryImbalanced}.pdf}
}\\
\subfloat[][]{
\includegraphics[width=0.4\textwidth, height = 0.35\textwidth]{{changeSigma/plotSd0.09}.pdf}
}
\subfloat[][]{
\includegraphics[width=0.4\textwidth, height = 0.35\textwidth]{{changeSigma/plotSd0.03}.pdf}
}\\
...
\todonum{REV1.11.2: Parameters used in this analysis, and the analysis of other software, would also be useful.}
...
\todonum[inline]{REV1.12: Figure 3: pfmix infers the number of strains and their proportions, therefore please add the numbers of strains estimated by pfmix to Figure 3 panel (a)}
The \texttt{pfmix} method uses allele count information to infer the strain proportion. We extract reference and alternative allele counts, and save them in text files, which consist with three columns: chromosome information, position, and allele counts. \textcolor{red}{This method works sample-by-sample, infers the number of strains and proportions only based on the allele frequency imbalance within sample: It infers the strain proportions when assuming the number of strains from one to eight, then uses the Bayesian information criterion to choose the best model. As in the attempt of applying \texttt{pfmix} to the same dataset is unsuccessful, we ignore the model selection step of \texttt{pfmix}, and infer proportions directly with fixed number of strains.}
 %`R' code %To run the analysis, use the following command,

\subsection{\texttt{BEAGLE}}
\todonum{REV1.11.1: BEAGLE requires a reference dataset to infer haplotype phase, typically a large reference dataset. What reference dataset was used? Parameters used in this analysis, and the analysis of other software, would also be useful.}
