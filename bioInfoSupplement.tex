...
We use $\psi_i$ to denote the genetic distance, and $\rho_i'$ to denote the probability of \textbf{no} recombination between site $i$ and $i+1$, we have $\rho_i' = \exp(-\psi_i)$.
