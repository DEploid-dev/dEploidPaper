...
\caption{Run-time and scaling.  CPU time (seconds) for deconvoluting chromosomes 12, 13 and 14 of sample {\textmd PG0412-C} with reference panels I, V and VI, where panel V contains 3D7, HB3, 7G8 and Dd2 strains; and panel VI is equivalent to panel I with the addition of six clonal strains from Asia and Africa: {\textmd PH0193-C}, {\textmd PH0283-C}, {\textmd PH0305}, {\textmd PT0060-C}, {\textmd PT0146-C} and {\textmd PT0158-C}. The run-time is approxmately linear with respect to the number of sites and shows the expected quadratic trend against the number of reference strains.}\label{fig:runtime}
\end{figure}
...
\newblock{\em Nature Genetics\/}~{\em 48\/}, 965--969. doi:10.1038/ng.3594.
...
\newblock {\em PLOS Genetics\/}~{\em 10\/}(4), e1004234.
