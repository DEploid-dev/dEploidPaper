...
\begin{figure}[tbh]
\centering
\includegraphics[width=0.5\textwidth]{LS.pdf}
...
\begin{figure}[htb]
\centerline{
\includegraphics[width=0.45\textwidth]{{switchVsMisCopyErrlogHi}.pdf}
}
...
\begin{figure}[htb]
\centering
\includegraphics[width=.45\textwidth]{runTimeHi.pdf}
