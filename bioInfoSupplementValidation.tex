...
\includegraphics[width=0.5\textwidth]{figures/validation/dd2marker709668.png}
}
\subfloat[]{\label{fig:dd2_gt1}
\includegraphics[width=0.5\textwidth]{figures/validation/dd2marker281734.png}
}
...
\includegraphics[width=0.33\textwidth]{figures/validation/marker73802.png}
}
\subfloat[]{\label{fig:hb3}
\includegraphics[width=0.33\textwidth]{figures/validation/marker518472.png}
}
\subfloat[]{\label{fig:7g8}
\includegraphics[width=0.33\textwidth]{figures/validation/marker128657.png}
}
\caption{\textcolor{red}{XXXXXXXXXXXXXX}}
\end{figure}
...
\begin{table}[ht]
\caption{\color{red}{Inferred proportions from Jason's samples}}
\begin{center}
\missingfigure[figwidth=6cm]{With updated proportions!!!}
\end{center}
%\begin{tabular}[c]{@{}l|llll@{}}
%sample    & 3D7 (F) & Dd2 (C) & HB3 (C) & 7G8 (C)\\ \hline
%%{\tt PG0218\-C} & 100 & 0 & 0 & 0\tabularnewline
...
\bibitem[\protect\citeauthoryear{MalariaGEN}{MalariaGEN}{2008}]{MalariaGen2008:sup}
MalariaGEN (2008).
