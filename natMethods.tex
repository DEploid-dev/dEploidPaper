...
\begin{figure*}[htb]
\centerline{
\includegraphics[width=\textwidth]{{differentPanelForSample.PG0396-C}.pdf}
}
...
\begin{figure}[htb]
\centerline{
\includegraphics[width=0.9\textwidth]{{switchVsMisCopyErrlogHi}.pdf}
}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\textwidth]{runTimeHi.pdf}
