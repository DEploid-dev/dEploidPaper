...
\centering
\subfloat[][]{
\includegraphics[width=.47\textwidth]{{supplementDEploidExample/PG0396-C1}.pdf}
}%\label{fig:pg0396.interpret1}
\subfloat[][]{
\includegraphics[width=.53\textwidth]{{supplementDEploidExample/PG0396-C2}.pdf}
}\\
%\caption{}
%\end{figure}
...
%\ContinuedFloat
\subfloat[][]{
\includegraphics[width=.32\textwidth]{{supplementDEploidExample/PG0396-Csingle0}.pdf}
}
\subfloat[][]{
\includegraphics[width=.32\textwidth]{{supplementDEploidExample/PG0396-Csingle1}.pdf}
}
\subfloat[][]{
\includegraphics[width=.32\textwidth]{{supplementDEploidExample/PG0396-Csingle2}.pdf}
}\\
...
\begin{figure}[th]
\subfloat[][]{
\includegraphics[width=.47\textwidth]{{supplementDEploidExample/PG0415-C1}.pdf}
}
\subfloat[][]{
\includegraphics[width=.53\textwidth]{{supplementDEploidExample/PG0415-C2}.pdf}
}\\
\subfloat[][]{
\includegraphics[width=.32\textwidth]{{supplementDEploidExample/PG0415-Csingle0}.pdf}
}\label{fig:pg0415.postprob_a}
\subfloat[][]{
\includegraphics[width=.32\textwidth]{{supplementDEploidExample/PG0415-Csingle1}.pdf}
}\label{fig:pg0415.postprob_b}
\subfloat[][]{
\includegraphics[width=.32\textwidth]{{supplementDEploidExample/PG0415-Csingle2}.pdf}
